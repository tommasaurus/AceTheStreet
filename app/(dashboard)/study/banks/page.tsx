            ...
            >
              <Link href={`/study/banks/${bank.id}`} className='block group'>
                <Card className='relative h-[280px] rounded-3xl border-0 bg-[#ECECEC] dark:bg-[#1c2936] p-8 overflow-hidden transition-all duration-500'>
                  {/* Gradient Background */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${bank.gradient} opacity-0 group-hover:opacity-5 dark:group-hover:opacity-10 transition-opacity duration-500`}
                  />
